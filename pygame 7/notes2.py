...
while not done:
        ...
        screen.blit(get_image('ball.png'), (50,60))
...
while running:  
    ...
    blit_rotate_center(screen, minute_arrow, CENTER, minute_angle)
    blit_rotate_center(screen, second_arrow, CENTER, second_angle)
    pygame.display.flip()
    clock.tick(FPS)
pygame.quit()